...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login p-3" method="post">
			...
			<p class="form-row">
				...
				<button type="submit" class="main-button" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
			</p>
	...
	<div class="col-sm-12 col-lg-6">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register p-3" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<p class="woocommerce-FormRow form-row">
				...
				<button type="submit" class="main-button" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
			</p>
